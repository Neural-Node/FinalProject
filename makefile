...
main: main.cu MergeSort_CPU.cu MergeSort_CPU.h MergeSort_GPU.o MergeSort_GPU.h
	nvcc -arch=sm_86 main.cu MergeSort_CPU.cu MergeSort_GPU.o -o main
...
clean:
	rm -f main.o MergeSort_CPU.o MergeSort_GPU.o